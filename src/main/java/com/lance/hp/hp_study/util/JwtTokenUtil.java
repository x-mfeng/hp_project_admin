package com.lance.hp.hp_study.util;
 ...
 * @createTime 2022/05/17 14:55:00
...
public class JwtTokenUtil {
     ...
     * @param accountName 从数据库中查询出来的用户信息
     */
    public boolean validateToken(String token,String accountName){
        String username=getUserNameFromToken(token);
        return username.equals(accountName)&&!isTokenExpired(token);
    }
    ...
    public  String generateToken(String accountName){
        ...
        claims.put(CLAIM_KEY_USERNAME, accountName);
